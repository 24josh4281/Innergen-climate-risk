...
### Phase 1~5 핵심 출력 (scenarios_v2/output/)

| 파일 | 내용 | 형태 |
|------|------|------|
| `OCI_MASTER_SUMMARY_SSP585.csv` | **통합 마스터** — 전 지수 SSP5-8.5 2090s 스냅샷 | 13×23 |
| `OCI_4SSP_ETCCDI_SUMMARY.csv` | 4SSP × 13 ETCCDI 2090s 와이드 피벗 | 13×54 |
| `OCI_TXx_4SSP_Trajectory.csv` | TXx 극한기온 4SSP × 8기간 궤적 | 13×34 |
| `ph3_etccdi_4ssp.csv` | ETCCDI 13지수 × 4SSP × 8기간 × 13사업장 | 5408×7 |
| `ph4_return_period.csv` | GEV 10/50/100년 재현기간 강수량 | 26×11 |
| `ph4_compound_events.csv` | 복합 폭염+건조 이벤트 확률 (근기/원기) | 26×7 |
| `ph1_cdd_hdd.csv` | 냉난방도일(CDD/HDD) × 4SSP × 8기간 | 26×19 |
| `ph1_humidex.csv` | Humidex + Apparent Temp × 4SSP × 8기간 | 26×20 |
| `ph1_spi3.csv` | SPI-3 강수지수 × 2SSP × 8기간 | 26×11 |
| `ph1_fwi.csv` | 화재기상지수(FWI) × 4SSP × 8기간 | 26×19 |
| `ph1_pe_balance.csv` | P-E 균형 × 2SSP × 8기간 | 26×11 |
